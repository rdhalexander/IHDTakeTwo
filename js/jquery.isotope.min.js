...
var jQuerycontainer = jQuery('#container');var filters = {};function noResultsCheck() {var noResults = jQuery('.no-results');var numItems = jQuery('.main:not(.isotope-hidden)').length;
    if (numItems === 0) {
        noResults.show();
    } else {
        noResults.hide();
...
jQuery('.combo a').click(function () {
    ...
    jQuerycontainer.isotope('reLayout', noResultsCheck);
    return false;
});
...
jQuery('.reset-options a').click(function () {
    var jQuerythis = jQuery(this);
...
jQuery('.no-results a').click(function () {
    ...
    jQuery('.no-results').hide();jQuerycontainer.isotope({filter: getFilterSelector()});return false;});